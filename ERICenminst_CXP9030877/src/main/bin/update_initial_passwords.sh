...
#
# ********************************************************************
# Name    : update_initial_passwords.sh
# Purpose : Wrapper script calling set_initial_passwords.py
#
# ********************************************************************
...
function ctrl_c() {
    echo "Script exit by the user."
    reset
    exit 1
}

${PYTHON} "${ENMINST_LIB}/update_initial_passwords.py"