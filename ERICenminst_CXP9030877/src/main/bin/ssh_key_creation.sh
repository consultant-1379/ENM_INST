...
#
# ********************************************************************
# Name    : ssh_key_creation.sh
# Purpose : Wrapper script calling ssh_key_creation.py.
#
# ********************************************************************
...
export PYTHONPATH=${PYTHONPATH}:${ENMINST_LIB}:${LITP_LIB}

${PYTHON} ${ENMINST_LIB}/ssh_key_creation.py "$@" 2>&1
exit $?
